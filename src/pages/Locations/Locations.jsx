    ...
    <Layout>
      <section className="location-section hero-padding section-padding-inline">
        <div className="location location--canada container grid">
          <div className="location__text-content background-very-light-peach flow flex flex--column flex--justify-center">
            <h2 className="location__heading secondary-heading text-peach">
              Canada
            </h2>
            <div className="location__contact-wrapper grid">
              <div className="location__address-wrapper font-size-100 text-dark-grey">
              ...
              <div className="location__contact-box font-size-100 text-dark-grey">
          ...
          <div className="location__text-content background-very-light-peach flow flex flex--column flex--justify-center">
            ...
            <div className="location__contact-wrapper grid">
              <div className="location__address-wrapper">
                <p className="location__address font-size-100 text-dark-grey text-bold">
                  Designo UK Office
                </p>
                <p className="location__address font-size-100 text-dark-grey">
                  13 Colorado Way
                </p>
                <p className="location__address font-size-100 text-dark-grey">
                  Rhyd-y-fro SA8 9GA
              ...
              <div className="location__contact-box">
                <p className="location__contact-heading font-size-100 text-dark-grey text-bold">
                  Contact{" "}
                </p>
                <a
                  className="location__contact-link font-size-100 text-dark-grey text-decoration-none"
